...
public class CalculadoraComData {
    ...
    public static void main(String[] args){
        ...
        Loja loja = new Loja("My Plant", "My Plant LTDA", "12.345.678/0001-99", "Medianeira", "Centro", "Rua das Flores");
        ...
        do{
            ...
            switch(opcao){
                ...
                case 7:
                    ...
                    Endereco e = new Endereco("PR","Medianeira","Centro",123,"Apto");
                    loja = new Loja("My Plant", "123456", e);
                    Cliente cliente = new Cliente("Ana",25,e);
                    Vendedor vendedor = new Vendedor("Carlos",30,e,"My Plant",2000);

                    ProcessaPedido proc = new ProcessaPedido();
                    Pedido pedido = proc.processar(cliente, vendedor, loja);
